...
tk.Button(operators, cnf=con["op1"], command=lambda: press("lop1")).grid(row=0, column=0, padx=35, pady=10)
tk.Button(operators, cnf=con["op2"], command=lambda: press("lop2")).grid(row=0, column=1, padx=35, pady=10)
tk.Button(operators, cnf=con["op3"], command=lambda: press("lop3")).grid(row=0, column=2, padx=35, pady=10)
